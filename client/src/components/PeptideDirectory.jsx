    ...
    <section className="rounded-2xl border border-border bg-surface p-5 shadow-sm">
      <div className="flex flex-wrap gap-3 items-start justify-between mb-4">
        ...
        <input
          ...
          className="rounded-xl border border-border bg-surface-alt px-3 py-2.5 text-sm text-text placeholder:text-text-light focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none min-w-[220px] transition-colors"
        />
      </div>
